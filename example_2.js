$(function () {
    ...
    for (i in stasiun.features) {
        var title = stasiun.features[i].properties.namobj,  //value searched
            info ="<center>"+ stasiun.features[i].properties.namobj +"</center><br><img src=\""+stasiun.features[i].properties.image+"\" width=\"200px\">",
    ...
    var overLayers = [
        {
            name: "Rel Kereta Yogyakarta - Surabaya",
            icon: iconByName('bar'),
            layer: new L.GeoJSON(jogsub, { onEachFeature: popUp, style: myStyle, pointToLayer: featureToMarker }).addTo(map)
        },
        {
            name: "Rel Kereta Surabaya - Yogyakarta",
            icon: iconByName('drinking_water'),
            layer: new L.GeoJSON(subjog, { onEachFeature: popUp, style: myStyle, pointToLayer: featureToMarker }).addTo(map)
        },
        {
            name: "stasiun",
            icon: iconByName('drinking_water'),
            layer: markersLayer.addTo(map)
        },
    ];
    ...
    // Add data
    playback.addData(ka75A, ka175, ka79, ka5, ka285, ka253A, ka103A, ka76, ka176, ka80, ka6, ka286, ka254A, ka104A);
